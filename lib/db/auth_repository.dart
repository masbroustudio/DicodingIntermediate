...
class AuthRepository {
  // tambahkan beberapa methoduntuk menyimpan dan memeriksa sesi login seperti kode di bawah ini.
  // dan perlu menyimpan informasi pengguna saat melakukan registrasi akun. Untuk mengelola informasi pengguna
